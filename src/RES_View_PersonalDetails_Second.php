 	...
 	<!---->
        ...
        <form action ="?" method = "post" >
			...
			<div class="col-md-12 form-group1 group-mail">
              ...
              <input type="date" input name="DateOfBirth" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" input value =<?php echo $fetch['DateOfBirth'] ?> required="">
            </div>
			...
			<div class="col-md-12 form-group1 group-mail">
              ...
              <input type="date" input name="SDateOfBirth" input value =<?php echo $fetch['SpouseDateOfBirth'] ?> class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
            </div>
